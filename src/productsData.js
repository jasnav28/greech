...
export const PRODUCTS = [
  ...
  {
    brand: 'Red Mite',
    specification: 'Sargassum tenerrimum 10% (II) (liquid)',
    category: 'Seaweed Extract',
    crops: ['Chilli'],
    dosage: ['Three foliar applications at 1500 ml/ha'],
    gazette: '13th August, 2025 S.O. 3741(E).',
    composition: [
      '(i) Seaweed (Sargassum tenerrimum) extract per cent. weight by volume, minimum 10',
      '(ii) Formalin per cent. weight by volume, minimum 0.5',
      '(iii) Polysorbate 80 per cent. weight by volume, minimum 0.5',
      '(iv) Water per cent. weight by volume 89',
      '(v) Total (per cent.) 100'
    ]
  },
  {
...
export const SLUG_TO_BRAND = {
  'SOIL RICH': 'SOIL RICH',
  'SOIL-RICH': 'SOIL RICH',
  'SOIL%20RICH': 'SOIL RICH',
  'RED GRAM': 'Red Gram',
  'RED-GRAM': 'Red Gram',
  'RED%20GRAM': 'Red Gram',
  'FLOWER': 'Flower',
  'PUSHPAK GOLD': 'Pushpak Gold',
  'PUSHPAK-GOLD': 'Pushpak Gold',
  'PUSHPAK%20GOLD': 'Pushpak Gold',
  'CHINNA': 'Chinna',
  'ADVIN': 'Advin',
  'SWARNA': 'Swarna',
  'KAVACHA': 'Kavacha',
